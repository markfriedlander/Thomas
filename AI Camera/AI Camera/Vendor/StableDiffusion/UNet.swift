...
nonisolated func upsampleNearest(_ x: MLXArray, scale: Int = 2) -> MLXArray {
...
nonisolated class TimestepEmbedding: Module, UnaryLayer {
...
nonisolated class TransformerBlock: Module {
...
nonisolated class Transformer2D: Module {
...
nonisolated class ResnetBlock2D: Module {
...
nonisolated class UNetBlock2D: Module {
...
nonisolated class UNetModel: Module {
