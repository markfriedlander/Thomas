...
nonisolated func interpolate(y: MLXArray, xNew: MLXArray) -> MLXArray {
...
nonisolated class SimpleEulerSampler {
...
nonisolated class SimpleEulerAncestralSampler: SimpleEulerSampler {
