...
nonisolated public struct LoadConfiguration: Sendable {
...
nonisolated public struct EvaluateParameters: Sendable {
...
nonisolated public struct StableDiffusionConfiguration: Sendable {
...
nonisolated func keyReplace(_ replace: String, _ with: String) -> @Sendable (String) -> String? {
...
nonisolated func dropPrefix(_ prefix: String) -> @Sendable (String) -> String? {
...
nonisolated let unetRules: [@Sendable (String) -> String?] = [
    // Map up/downsampling
...
nonisolated func unetRemap(key: String, value: MLXArray) -> [(String, MLXArray)] {
    var key = key
    var value = value
...
nonisolated let clipRules: [@Sendable (String) -> String?] = [
...
nonisolated func clipRemap(key: String, value: MLXArray) -> [(String, MLXArray)] {
    var key = key
...
nonisolated let vaeRules: [@Sendable (String) -> String?] = [
    // Map up/downsampling
    keyReplace("downsamplers.0.conv", "downsample"),
    keyReplace("upsamplers.0.conv", "upsample"),
...
nonisolated func vaeRemap(key: String, value: MLXArray) -> [(String, MLXArray)] {
    var key = key
    var value = value
...
nonisolated func resolve(hub: HubApi, configuration: StableDiffusionConfiguration, key: FileKey) -> URL {
    precondition(
...
nonisolated func loadConfiguration<T: Decodable>(
...
nonisolated func loadUnet(hub: HubApi, configuration: StableDiffusionConfiguration, dType: DType) throws
    -> UNetModel
{
...
nonisolated func loadTextEncoder(
...
nonisolated func loadAutoEncoder(hub: HubApi, configuration: StableDiffusionConfiguration, dType: DType) throws
    -> Autoencoder
{
...
nonisolated func loadDiffusionConfiguration(hub: HubApi, configuration: StableDiffusionConfiguration) throws
...
nonisolated func loadTokenizer(
    hub: HubApi, configuration: StableDiffusionConfiguration,
