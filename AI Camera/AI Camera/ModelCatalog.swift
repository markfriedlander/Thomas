...
nonisolated enum ModelCatalog {
    ...
    static let qwen = CameraModel(
        ...
        delivery: .wholeRepo,
        sizeGB: 1.63,
        blurb: "No filter of any kind. Sees more than Apple's model, and largely ignores instructions about how to speak. First look after launch takes about 9 seconds while it loads; after that about 3.",
        licence: "Apache 2.0"
    )
